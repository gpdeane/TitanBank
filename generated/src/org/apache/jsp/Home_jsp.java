...
public final class Home_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 String username = request.getParameter("username");
    String password = request.getParameter("password");
      ...
      out.write('\n');
      out.write('\n');
      com.Titan_Bank.domain.bll.UserBean user = null;
      synchronized (session) {
        user = (com.Titan_Bank.domain.bll.UserBean) _jspx_page_context.getAttribute("user", PageContext.SESSION_SCOPE);
        if (user == null){
          user = new com.Titan_Bank.domain.bll.UserBean();
 ...
 user.setPassword("password");
    ...
    if (!(user.getPassword().equals(password))) {
      ...
      out.write("        <title>Titan Bank Home</title>\n");
      out.write("    </head>\n");
      out.write("    <body>\n");
      out.write("        ");
      out.write("\n");
      ...
      out.write("                <a href=\"\" id=\"accounts\">Accounts&nbsp;</a>\n");
      ...
      out.print(username);
      out.write("!</p>\n");
      out.write("                <img src=\"big-bank-building.jpg\" alt=\"big bank\">\n");
      out.write("            </div>\n");
      out.write("\n");
      out.write("        </div>\n");
      out.write("    </body>\n");
